...
const UniversityDetails = () => {
  ...
  const scrollWithOffset = (ref) => {
    const offset = 200; // Adjust this to match your sticky navbar height
      ...
      <Header displaySearch={true} />
      {
        ...
        <div className="animate-spin rounded-full h-12 w-12 border-t-2"></div>
          ...
          <div className='relative my-[50px]'>
            <div className='m-auto max-w-[100rem]  rounded-[20px] rounded-b-[0px] flex flex-col shadow-xl p-[40px] pb-[30px] border-[1px] border-black-300'>
              <Image src={contextCurrentUniversity?.mascot_photo} width={100} height={100} alt="college_mascot" className='rounded-[20px]'/>
